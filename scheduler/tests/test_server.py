...
class TestServer(unittest.TestCase):
    ...
    def test_send_study(self):
        res = self.app.post('/api/v1/study', data=json.dumps({'version': '1'}))
    ...
    def test_get_result_terminated(self):
        ...
        # Test & Verify
        res = self.app.get('/api/v1/result/123')
        res = json.loads(res.data)
    ...
    def test_get_next_job(self):
        ...
        # Test & Verify
        res = self.app.get('/api/v1/job/next/1.1')
    ...
    def test_update_job(self):
        ...
        # Test & Verify
        self.app.post('/api/v1/job/123', data=json.dumps(job.to_json()))
